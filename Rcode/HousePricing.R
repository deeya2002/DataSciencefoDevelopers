...
write.csv(HousePrices, "combined/Combined_House_Pricing_2019-2022.csv")
...
write.csv(FilteredHousePrices, "Clean/Cleaned_House_Pricing_2019-2022.csv",row.names = FALSE)
