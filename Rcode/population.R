...
uncleanedhouseprices = read_csv('Clean/Combined_House_Pricing_2019-2022.csv')

Population = read_csv("Datasets/Population2011_.csv", show_col_types = FALSE)
Population
...
write.csv(FilteredTown, "Clean/Cleaned_Town_population.csv",row.names = FALSE)
